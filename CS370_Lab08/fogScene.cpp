...
void draw_fog_color_obj(GLuint obj, GLuint color);
...
int main(int argc, char**argv)
{
    ...
    ShaderInfo fog_shaders[] = { {GL_VERTEX_SHADER, default_vertex_shader},{GL_FRAGMENT_SHADER, fog_frag_shader},{GL_NONE, NULL} };
...
void render_scene( ) {
    ...
    // Draw cube
    draw_fog_color_obj(Cube, CubeRed);
    ...
    model_matrix = trans_matrix*rot_matrix*scale_matrix;
    // Draw sphere
    draw_fog_color_obj(Sphere, SphereYellow);
